...
| Entire English report, including references, ≤7 pages | **7 pages**, `Group5_Final_Report.pdf`; teacher-template 10pt body (9pt references); abstract, three figures and six numbered tables, including partitions and contributions. Math subscripts are smaller glyphs, not reduced body type. |
