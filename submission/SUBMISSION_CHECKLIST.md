...
| Entire English report, including references, ≤7 pages | **7 pages**, `Group5_Final_Report.pdf`; teacher-template 10pt body and references; APA 7 author–date citations and an alphabetical reference list; abstract, three figures and six numbered tables, including partitions and contributions. Math subscripts are smaller glyphs, not reduced body type. |
