...
NTU SC6122 Emerging Topics in FinTech --- Group 5\hfill 7 September 2026\par
{\small Lei Peng (G2509090C) \quad Zhang Hanyu (G2509091L)\\
Zhou Xinzhe (G2509033F) \quad Xu Yiqun (G2509092H)}\par
...
Partition & Clients & Use in the experiment\\\midrule
Fitting & 18,000 & Five-fold CV for model selection; selected model fitted on all fitting rows\\
Validation & 6,000 & Selection of decision thresholds\\
Test & 6,000 & Evaluation of frozen models and decisions\\\bottomrule
\end{tabularx}\end{center}
\smallcap{Fixed stratified partitions, seed 42. Each inner CV fold uses 14,400 training and 3,600 holdout rows.}
\newpage
...
\smallcap{Figure 1. Test AP for declared baselines and CV-selected models. The dashed reference is positive prevalence (0.2212). Selection uses fit-fold CV, never this chart.}
...
\smallcap{Figure 2. Moving the same tuned XGBoost from 0.5 to its validation cutoff changes FP/FN and workload. Ranking scores remain unchanged.}
...
\smallcap{Figure 3. Tuned XGBoost validation permutation importance, top six features. Error bars are the SD across five permutations, not confidence intervals or causal estimates. Horizontal units: decrease in validation AP.}
...
G2509090C} & Part 1: Data and logistic regression; slides 1--3 & 25\%\\
\shortstack[l]{Zhang Hanyu\\
G2509091L} & Part 2: Decision tree and model comparison; slides 4--6 & 25\%\\
\shortstack[l]{Zhou Xinzhe\\
G2509033F} & Part 3: Random forest and experiment audit; slides 7--9 & 25\%\\
\shortstack[l]{Xu Yiqun\\
G2509092H} & Part 4: XGBoost and cost analysis; slides 10--12 & 25\%\\
\bottomrule\end{tabularx}\end{center}
\smallcap{Contribution shares are equal at 25\% per member, as confirmed by the group. Integration and the LR supplement were prepared with AI assistance for member review. Each member presents a substantive model section.}
