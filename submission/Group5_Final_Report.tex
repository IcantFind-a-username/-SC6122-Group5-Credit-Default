...
\smallcap{Figure 3. Tuned random-forest validation permutation importance, top six features. Error bars are the SD across five permutations, not confidence intervals or causal estimates. Horizontal units: decrease in validation AP.}
...
G2509090C} & Part 1: Data checks and preprocessing; logistic baseline; data characteristics and baseline performance; slides 1--3 & 25\%\\
...
G2509033F} & Part 3: Random-forest tuning; feature importance and illustrative misclassification cases; slides 7--9 & 25\%\\
\shortstack[l]{Xu Yiqun\\
G2509092H} & Part 4: XGBoost tuning; threshold trade-offs between missed defaults and false alarms; slides 10--12 & 25\%\\
\bottomrule\end{tabularx}\end{center}
\smallcap{Contribution shares are equal at 25\% per member, as confirmed by the group. Integration and the LR supplement were prepared with AI assistance for member review. All four agree data splits, preprocessing and metrics, write their sections, and jointly integrate, check and rehearse.}
