...
\textbf{Reproducibility.} The accompanying repository provides source data, fitted pipelines, row-aligned predictions, CV records and environment pins. Its README distinguishes verification from retraining; historical results and member contributions are preserved [4].
