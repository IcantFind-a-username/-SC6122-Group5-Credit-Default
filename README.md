...
- [Final report PDF](submission/Group5_Final_Report.pdf), now using the supplied teacher NeurIPS template, with a [self-contained source ZIP](submission/Group5_Report_Source.zip), editable [LaTeX](submission/Group5_Final_Report.tex) and [build notes](submission/REPORT_README.md); seven pages including APA 7 references, no separate cover.
